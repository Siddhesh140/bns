...
export default function Card({
    ...
    if (variant === 'problem') {
        return (
            <div className={`relative flex flex-col justify-end items-start w-full h-[500px] md:h-[630px] ${className}`}>
                ...
                />
                <div className="relative z-10 flex flex-col items-start justify-start p-5 md:p-9 gap-6 w-full bg-[#1A1A1A] min-h-[210px] md:min-h-[220px]">
                    <h3
    ...
    return (
        <div className={`flex flex-col items-start p-5 gap-5 w-full bg-[#191919] ${className}`}>
            {image && (
