        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Links Container (Frame 77 - gap 12) */}
                    <div className="flex flex-col items-start" style={{ gap: '12px', width: '130px' }}>
                        {/* Instagram */}
                        <a
                            href="https://www.instagram.com/bigvision2025/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-row items-center group transition-colors duration-300"
                            style={{ gap: '4px' }}
                        >
                            ...
                            <span
                                className="text-[#ADADAD] group-hover:text-[#3B82F6] transition-colors duration-300"
                                style={{
                                    fontFamily: 'var(--font-inter)',
                                    fontWeight: 400,
                                    fontSize: '16px',
                        ...
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/company/bigvision-consulting-marketing/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-row items-center group transition-colors duration-300"
                            style={{ gap: '4px' }}
                ...
                {/* Contact Column (Frame 77 - gap 20) */}
                <div
                    className="flex flex-col items-start"
                    style={{
                        gap: '20px',
                ...
                >
                    ...
                    {/* Info Container (Frame 80 - gap 16) */}
                    <div className="flex flex-col items-start" style={{ gap: '16px', width: '161px' }}>
                        {/* Email */}
                        <div className="flex flex-row items-center" style={{ gap: '9px' }}>
